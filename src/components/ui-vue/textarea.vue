...
// the real <textarea> disagrees between SSR and hydration and Vue flags it
// as a mismatch. Every other attr (onClick, id, aria-*, ...) still needs
// through.
...
<template>
  ...
  >
    ...
    <textarea
      ...
      class="outline-none px-8 py-2 relative field-sizing-content min-h-16 w-full placeholder:text-foreground/70"
    />
  </div>
</template>
