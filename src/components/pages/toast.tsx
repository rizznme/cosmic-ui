          ...
          <div>
            ...
            <div className="flex gap-3 mt-5">
              ...
              <a
                className="pr-3 pl-3.5 py-0.5 border border-primary/20 bg-primary/10 flex items-center gap-2 text-sm"
                target="_blank"
                href="https://zagjs.com/components/react/toast#api-reference"
              >
        ...
        <ToastCloseTrigger />
          ...
          <div id="installation">
            ...
            <SectionContent>
              ...
              page. Each toast in the list gets its own machine instance
              parented to a shared group machine, the same pattern Zag's own
              React adapter uses internally. Copy and paste the following code
              into your project.
            </SectionContent>
