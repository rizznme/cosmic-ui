      ...
      <Wrapper>
        <div className="flex flex-col gap-20">
          <div>
            <Title>Frame</Title>
            <Subtitle>
              Displays a customizable SVG frame for buttons, modals, and UI
              components.
            </Subtitle>
            <Preview>
              {() => ({
...
>
  ...
  />
          ...
          <div id="installation">
            ...
            <InstallPackage>add @left4code/svg-renderer</InstallPackage>
            <SectionContent>
              Copy and paste the following code into your project.
            </SectionContent>
            <PreviewCode title="components/ui/frame.tsx">
              {`
