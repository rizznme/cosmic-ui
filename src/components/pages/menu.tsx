          ...
          <div>
            ...
            <div className="flex gap-3 mt-5">
              <a
                ...
                target="_blank"
                href="https://zagjs.com/components/react/menu"
              >
              ...
              <a
                className="pr-3 pl-3.5 py-0.5 border border-primary/20 bg-primary/10 flex items-center gap-2 text-sm"
                target="_blank"
                href="https://zagjs.com/components/react/menu#api-reference"
              >
      ...
      <MenuItem value="export">
        <FileUp className="size-4 me-2.5" /> Export...
          ...
          <div id="installation">
            ...
            <InstallPackage>add @zag-js/menu @zag-js/react @zag-js/presence</InstallPackage>
            <SectionContent>
              This component is built directly on the Zag.js state machine (not
              a wrapper), plus two small shared primitives used by every
              portal-based component in this library: an SSR-safe{" "}
              ...
              hook that keeps content mounted through its exit animation. Copy
              all three files into your project.
            </SectionContent>
            <PreviewCode title="components/ui/portal.tsx">
              {`
...
export { Portal };
            ...
            <PreviewCode title="components/ui/presence.ts">
              {`
