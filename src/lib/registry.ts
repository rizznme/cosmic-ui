...
const DESCRIPTIONS: Record<string, string> = {
  ...
  "button-01": "A variant of Button - transparent with a colored border, fills solid on hover.",
  "button-02": "A variant of Button - no border, just a background tint on hover.",
  "button-03": "A variant of Button - filled block, no border, high contrast.",
